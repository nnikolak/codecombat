...
#    None: "None"
  ...
  login:
    ...
    email_or_username: "Διεύθυνση Ηλεκτρονικής Αλληλογραφίας ή Όνομα Χρήστη"
    log_in: "Σύνδεση"
  ...
  signup:
    create_student_header: "Δημιουργία Λογαριασμού για Μαθητή"
    create_teacher_header: "Δημιουργία Λογαριασμού για Καθηγητή"
#    create_individual_header: "Create Individual Account"
    ...
    connected_gplus_header: "Έχετε συνδεθεί επιτυχώς μέσω Google+!"
#    connected_gplus_p: "Finish signing up so you can log in with your Google+ account."
#    gplus_exists: "You already have an account associated with Google+!"
    connected_facebook_header: "Έχετε συνδεθεί επιτυχώς μέσω Facebook!"
...
#    student_type_3: "Compete in arenas"
    student_type_4: "Διάλεξε τον Ήρωα σου!"
...
#    get_certificate: "Get your certificate!"
    level_complete: "Το Επίπεδο Ολοκληρώθηκε"
    ...
    languages: "Γλώσσες"
    programming_language: "Γλώσσες Προγραμματισμού"
    ...
    test_level: "Δοκιμαστικό Επίπεδο"
    victory: "Νίκη"
    ...
    victory_new_hero: "Καινούριος Ήρωας"
...
#    premium: "Premium" # Make sure the following feature translations don't go onto two lines
    ...
    feature8: "<strong>Χωρίς Διαφημίσεις!</strong>"
...
#    string: "string"
    ...
    required_parameters: "Απαιτούμενοι Παράμετροι"
...
#    maka_blurb: "Storyteller"
    rob_title: "Μηχανικός Λογισμικού"
#    rob_blurb: "Codes things and stuff"
    josh_c_title: "Σχεδιαστής Παιχνιδιού"
    josh_c_blurb: "Σχεδιάζει Παιχνίδια"
#    robin_title: "Product Manager"
#    robin_blurb: "Ships things"
    josh_title: "Σχεδιαστής Παιχνιδιού"
    josh_blurb: "Το Πάτωμα Είναι Λάβα"
    phoenix_title: "Μηχανικός Λογισμικού"
...
#    liz_title: "Territory Manager"
    ...
    community_title: "...και η ανοιχτού κώδικα κοινότητα μας"
...
#    jobs_benefit_9: "10-year option exercise window"
    jobs_benefit_10: "Άδεια Μητρότητας: 10 Εβδομάδες Πληρωμένες, οι Επόμενες 6 με 55% Μισθό"
...
#    screenshots_hint: "(lick to view full size)"
